...
export class HouseRent1634060512009 implements MigrationInterface {
    name = 'HouseRent1634060512009'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "user" ("id" SERIAL NOT NULL, "creationDate" TIMESTAMP NOT NULL DEFAULT '"2021-10-12T17:41:52.223Z"', "lastActivity" TIMESTAMP NOT NULL DEFAULT '"2021-10-12T17:41:52.224Z"', "avatar" character varying, "firstName" character varying(50) NOT NULL, "lastName" character varying(100) NOT NULL, "isEmailVerified" boolean NOT NULL DEFAULT false, "email" character varying(50) NOT NULL, "password" character varying NOT NULL, "role" text, CONSTRAINT "UQ_e12875dfb3b1d92d7d7c5377e22" UNIQUE ("email"), CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`);
