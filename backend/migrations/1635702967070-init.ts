...
export class init1635702967070 implements MigrationInterface {
    name = 'init1635702967070'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "posts" ("id" SERIAL NOT NULL, "status" character varying NOT NULL DEFAULT '{"IDLE":"idle","DRAFT":"draft","ACTIVE":"active","ARCHIVE":"archive"}', "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "views" integer NOT NULL DEFAULT '0', "title" character varying NOT NULL, "description" character varying NOT NULL, "residentsAmount" integer NOT NULL, "children" character varying, "pets" character varying, "image" character varying, "generalFilters" text array, "roomFilters" text array, "houseTypeFilters" text array, "priceFilters" text array, "cityFilters" character varying, "districtFilters" text array, "userId" integer, CONSTRAINT "PK_2829ac61eff60fcec60d7274b9e" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "users" ("id" SERIAL NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "lastActivity" TIMESTAMP NOT NULL DEFAULT now(), "avatar" character varying, "firstName" character varying(50) NOT NULL, "lastName" character varying(100) NOT NULL, "isEmailVerified" boolean NOT NULL DEFAULT false, "email" character varying(50) NOT NULL, "password" character varying NOT NULL, "role" text, CONSTRAINT "UQ_97672ac88f789774dd47f7c8be3" UNIQUE ("email"), CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "messages" ("id" SERIAL NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP, "text" character varying(500) NOT NULL, "isNew" boolean NOT NULL DEFAULT true, "uploads" text array NOT NULL DEFAULT '{}', "authorId" integer, "chatId" integer, CONSTRAINT "PK_18325f38ae6de43878487eff986" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "chats" ("id" SERIAL NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "users" integer array NOT NULL DEFAULT '{}', CONSTRAINT "PK_0117647b3c4a4e5ff198aeb6206" PRIMARY KEY ("id"))`);
