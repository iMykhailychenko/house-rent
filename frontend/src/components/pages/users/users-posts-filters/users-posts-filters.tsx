...
import { changePostStatusFilterAction } from '../../../../state/entities/filters/filters.reducer';
import { usePostStatusFiltersSelector } from '../../../../state/entities/filters/filters.selector';
...
const UsersPostsFilters = (): ReactElement => {
    ...
    const toggleSelectAll = (): void => {
        const isAllSelected = ALL_STATUSES.every(status => statusFilters[status].active);
        dispatch(changePostStatusFilterAction(isAllSelected ? [] : ALL_STATUSES));
    };
        ...
        <>
            ...
            <div className={css.root}>
                ...
                <Checkbox
                    ...
                    title={trans('Вибрати усі статуси')}
